export const blogData = [
    {
        id: 1,
        title: 'How to compute the histogram of a tensor in PyTorch?',
        description: 'Here we will use Pytorch to compute histogram and learn practically.',
        date: 'Aug 7, 2020',
        ...
        url: 'https://www.geeksforgeeks.org/how-to-compute-the-histogram-of-a-tensor-in-pytorch/'
    },
    {
        id: 2,
        title: 'PyBrain – Importing Data For Datasets',
        description: 'Learn the basics of PyBrain and implement practically and learn to import data.',
        date: 'Aug 11, 2020',
        image: 'https://datatrained.com/post/wp-content/uploads/2022/03/PyBrain.webp',
        url: 'https://www.geeksforgeeks.org/pybrain-importing-data-for-datasets/'
    },
    // {
    //     id: 3,
